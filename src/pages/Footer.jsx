...
const Footer = () => {
  return (
    <footer className="border-t border-darkGray">
      <div className="container mx-auto px-4 py-8 md:px-16 flex flex-col md:flex-row space-y-3 md:space-y-0 items-center justify-between text-light opacity-50">
